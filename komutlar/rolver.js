...
if (!message.member.hasPermission("KICK_MEMBERS")) return message.channel.send(new Emran.MessageEmbed().setDescription ('Bu komudu kullanmak için **sunucudan at** yetkisine sahip olmalısın.').setColor(10038562));
