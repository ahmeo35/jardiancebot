...
exports.run = async (bot, msg, args) => {
        ...
        .addField(`Durum`, user.presence.status.replace('online', 'Çevrimiçi').replace('idle', 'Boşta').replace('dnd', 'Rahatsız Etmeyin').replace('offline', 'Çevrimdışı'), false)
        .setColor('03f2df')
        ...
        .setFooter(`Türkiyem Aras Gaming | Kullanıcı Sistemi`)
